...
for source in sources:
	if source == 'Area_2_Acb_5' or source == 'Area_2_Iu_P2_6': # Inga told eliminate now
		continue
	if source == 'Area_2_P1AR_II_8': # A first approach - skip
		continue
	if source != 'Bottom':
		...
		if source == 'Area_2_J2_1': # Day surface case
	...
	NX = nx
	NY = ny
	if source == 'Area_2_J2_1':
		NZ = 120
	elif source == 'Area_2_A3_2':
		NZ = 20
	elif source == 'Area_2_Aan_3':
		NZ = 60
	elif source == 'Area_2_Ahr_4':
		NZ = 20
	elif source == 'Area_2_P1AR_I_7':
		NZ = 106
	elif source == 'Area_2_P1S_III_9':
		NZ = 10
	elif source == 'Area_2_C2_10':
		NZ = 20
	elif source == 'Bottom':
		NZ = 65
	else:
