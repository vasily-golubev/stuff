...
В виду того, что знаки коэффициента перед производной по координате в двух уравнениях переноса на инварианты различны, были соответствующим образом расширены функции $interpolatedValue$, $interpolatedDValue$, $fillStencilValues$ и $singleStep$.
...
\item{*Разработайте программы для решения системы уравнений акустики в двумерном и трёхмерном случае.
