...
Ввиду того, что знаки коэффициентов перед производной по координате в двух уравнениях переноса на инварианты различны, были соответствующим образом расширены функции $interpolatedValue$, $interpolatedDValue$, $fillStencilValues$ и $singleStep$.
