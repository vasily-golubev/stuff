...
\begin{gathered}
    ...
    =-\sum\limits_{A}c_e^A F_e^{int_A}=\\
    =-\mathbf{c_e^T F_e^{int}}
...
\begin{equation*}
    \begin{gathered}
        ...
        K^{\overline{A}}\in\{K_{e_1}^{13}, K_{e_1}^{23}+K_{e_2}^{14}, K_{e_2}^{24}, K_{e_1}^{34}+K_{e_2}^{12}, K_{e_2}^{34}+K_{e_4}^{12}, K_{e_3}^{24},\\
	K_{e_3}^{23}+K_{e_4}^{14}, K_{e_4}^{13}\}.
    \end{gathered}
\end{equation*}
