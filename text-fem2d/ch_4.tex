...
Посколько разные части равенства зависят от разных переменных, каждая из них должна быть равна некоторой константе. Введём константу $\lambda$, такую что
\begin{equation}
\label{a_3}
...
Его вид в черно-белой шкале представлен на рис. \ref{ris_1}.
...
Его вид в черно-белой шкале представлен на рис. \ref{ris_2}.
